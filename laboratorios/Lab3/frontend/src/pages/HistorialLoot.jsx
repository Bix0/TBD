...
function HistorialLoot() {
  ...
  useEffect(() => {
    axios
      .get(`/api/jugadores/${userId}/historial-loot`)
  ...
  return (
    ...
    >
      ...
      <div style={{ padding: "20px", maxWidth: "800px", margin: "0 auto" }}>
        ...
        >
          📜 Mi Historial de Botín (Todos mis Pjs)
        </h1>
        ...
        >
          ...
          {historial.length === 0 ? (
            <p style={{ textAlign: "center", padding: "20px", color: "#888" }}>
              No has ganado ningún botín aún.
            </p>
          ) : (
            historial.map((fila, i) => (
              ...
              >
                <div style={{ width: "25%", color: "#aaa", fontSize: "14px" }}>
                  {new Date(fila[0]).toLocaleString()}
                </div>
                <div
                  style={{ width: "25%", color: "#81c784", fontWeight: "bold" }}
                >
                  {fila[1]}
                </div>
